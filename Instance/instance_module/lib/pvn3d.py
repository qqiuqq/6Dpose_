...
class DenseFusion(nn.Module):
    def __init__(self, num_points):
        ...
        self.conv2_cld1 = torch.nn.Conv1d(9, 128, 1)
        self.conv2_rgb = torch.nn.Conv1d(128, 256, 1)
        self.conv2_cld2 = torch.nn.Conv1d(128, 256, 1)
...
class PVN3D(nn.Module):
    ...
    def forward(self, pointcloud, rgb, choose):
        ...
        _, N, _ = pointcloud.size()
        pcld_emb = pointcloud.transpose(1, 2).contiguous()
